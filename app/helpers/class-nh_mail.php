<?php
	...
	class Nh_Mail {
		...
		private string $headerDefaultTemplate = '';
		private        $headerTemplate        = FALSE;
		private array  $headerVariables       = [];
		private string $defaultTemplate       = '';
		private        $template              = FALSE;
		private array  $variables             = [];
		private string $footerDefaultTemplate = '';
		private        $footerTemplate        = FALSE;
		private array  $footerVariables       = [];

		public function __construct() {
			$this->templateStart         = Nh_Init::$_THEME_PATH . '/app/Views/email-template/';
			$this->headerDefaultTemplate = Nh_Init::$_THEME_PATH . '/app/Views/email-template/default/header';
			$this->defaultTemplate       = Nh_Init::$_THEME_PATH . '/app/Views/email-template/default/body';
			$this->footerDefaultTemplate = Nh_Init::$_THEME_PATH . '/app/Views/email-template/default/footer';
		}

		public static function init(): Nh_Mail {
			return new self;
		}
		 ...
		 * @return Nh_Mail $this
		 */
		public function bcc( $bcc ): Nh_Mail {
			if ( is_array( $bcc ) ) {
				$this->bcc = $bcc;
			} else {
				$this->bcc = [ $bcc ];
		 ...
		 * @return Nh_Mail $this
		 */
		public function from( $from ): Nh_Mail {
			$this->from = $from;
		 ...
		 * @return Nh_Mail $this
		 */
		public function headers( $headers ): Nh_Mail {
			if ( is_array( $headers ) ) {
		 ...
		 * @return Nh_Mail $this
		 */
		public function sendAsHTML( bool $html ): Nh_Mail {
		 ...
		 * @throws \Exception
		 */
		public function attach( $path ): Nh_Mail {
			if ( is_array( $path ) ) {
				$this->attachments = [];
		 ...
		 * @throws \Exception
		 */
		public function templateHeader( string $template, array $variables = NULL ): Nh_Mail {
		 ...
		 * @throws \Exception
		 */
		public function template( string $template, array $variables = NULL ): Nh_Mail {
			$template = $this->templateStart . $template . '.php';
		 ...
		 * @throws \Exception
		 */
		public function templateFooter( string $template, array $variables = NULL ): Nh_Mail {
			$template = $this->templateStart . $template . '.php';
