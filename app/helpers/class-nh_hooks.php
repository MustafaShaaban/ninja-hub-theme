<?php
	...
	class Nh_Hooks {
		...
		public function __construct() {
			self::$_PATHS = [
				'root'   => [
					'css' => Nh_Init::$_THEME_URI,
				],
				'admin'  => [
					'css'     => Nh_Init::$_THEME_URI . '/app/Models/admin/css',
					'js'      => Nh_Init::$_THEME_URI . '/app/Models/admin/js',
					'img'     => Nh_Init::$_THEME_URI . '/app/Models/admin/img',
					'vendors' => Nh_Init::$_THEME_URI . '/app/Models/admin/vendors'
				],
				'public' => [
					'js'      => Nh_Init::$_THEME_URI . '/app/Models/public/js',
					'img'     => Nh_Init::$_THEME_URI . '/app/Models/public/img',
					'images'  => Nh_Init::$_THEME_URI . '/app/Models/public/assets/images',
					'vid'     => Nh_Init::$_THEME_URI . '/app/Models/public/vid',
					'vendors' => Nh_Init::$_THEME_URI . '/app/Models/public/vendors'
				],
				'views'  => Nh_Init::$_THEME_PATH . '/app/Views'
			];
			if( class_exists( 'NH\NhChild' ) ) {
				$this->prefix = "production" === \NH\NhChild::$_ENVIRONMENT ? ".min" : "";
			} else {
		...
		private function enqueue( array $hooks, string $script_name, string $path, array $dependencies, $version = NULL, $position_media = NULL, bool $is_vendor = FALSE ): array {
			...
			$hooks[] = [
				...
				'version'      => ! empty( $version ) ? $version : ( class_exists( 'NH\NhChild' ) ? \NH\NhChild::$_VERSION : Nh::$_VERSION ),
				'is_vendor'    => $is_vendor
			];
